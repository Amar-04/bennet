       ...
       {/* Image Section */}
        ...
        >
          <div className="relative mx-4 md:mx-0">
            ...
            <div className="absolute -bottom-6 md:-bottom-10 -right-6 xl:bottom-0 xl:-right-2 2xl:-bottom-10 2xl:-right-8  md:-right-10 w-20 md:w-32 h-20 md:h-32 rounded-full bg-[#2C3D5A]/10 -z-10" />
            {/* Image container */}
            <div className="relative w-full aspect-square">
              <div className="absolute inset-0 rounded-2xl md:rounded-[2rem] overflow-hidden">
                <img
                  src="/OurProducts1.jpg"
                  alt="Medical products"
                  className="w-[42vw] object-cover hover:scale-105 transition-transform duration-300"
                />
              </div>
            </div>
          </div>
