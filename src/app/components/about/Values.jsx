...
const CoreValuesSection = () => {
  ...
  // Toggle function for expanding/collapsing the content
  const toggleContent = () => {
  ...
  return (
    <section className="max-w-[1440px] mx-auto px-0">
      <div className="bg-[#DFEAA580] py-16">
        ...
        <div
          className="w-full max-w-[1440px] mx-auto px-4 cursor-pointer"
          onClick={toggleContent} // Make the entire section clickable
        >
          {/* Header Section */}
