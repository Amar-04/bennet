...
const Leaders = () => {
  ...
  return (
    <>
   {/* Leadership Header (Dropdown Trigger) */}
   <motion.div
          className="flex justify-start container md:justify-center md:gap-0 lg:gap-0 items-center my-8 md:my-10 mb-10 md:mb-14 overflow-hidden cursor-pointer"
      ...
      {/* Conditional Rendering for Both Parts */}
      {isDropdownOpen && (
        <>
          {/* Part 1 */}
              ...
              {cardData.map((card, index) => (
                ...
                >
                  ...
                  <div className="absolute bottom-0 left-0 right-0 m-4 p-6 bg-white/90 backdrop-blur-sm rounded-xl transition-transform duration-300 group-hover:translate-y-0">
                    ...
                    <p className="font-bold text-[#AECA1D] mb-3">
                      {card.position}
                    </p>
